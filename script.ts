class VideoFrameAnalyzer {
    ...
    currentFrameSpan: HTMLElement;
    prevFrameBtn: HTMLElement;
    nextFrameBtn: HTMLElement;
    lapSelection: HTMLElement;
    lapTable: HTMLElement;
    lapTableBody: HTMLElement;
    telemetryDisplay: HTMLElement;
    speedValue: HTMLElement;
    latAccValue: HTMLElement;
    lonAccValue: HTMLElement;
    altitudeValue: HTMLElement;
    diffValue: HTMLElement;
    deltaBarContainer: HTMLElement;
    deltaBarFill: HTMLElement;
    deltaBarText: HTMLElement;
    gpsSection: HTMLElement;
    gpsCanvas: HTMLCanvasElement;
    gpsCtx: CanvasRenderingContext2D;
    gpsVisible: boolean;
    layerSelect: HTMLSelectElement;
    refreshMapBtn: HTMLElement;
    toggleGpsBtn: HTMLElement;
    currentMapLayer: string;
    tileCache: Map<string, HTMLImageElement>;
    loadingTiles: Set<string>;
    speedGraphContainer: HTMLElement;
    speedGraphCanvas: HTMLCanvasElement;
    speedGraphCtx: CanvasRenderingContext2D | null;
    speedGraphRange: HTMLElement;
    timelineEnd: HTMLElement;
    speedGraphVisible: boolean;
    speedGraphData: any[];
    speedGraphTimeWindow: number;
    ...
    currentWindowEndTime?: number;
    bestLapSpeedGraphData: any[];
    wasHighFrequencyActiveBeforeSeeking?: boolean;
    ...
    initializeElements() {
        ...
        this.csvInput = document.getElementById('csvFile') as HTMLInputElement;
        ...
        this.gpsCanvas = document.getElementById('gpsCanvas') as HTMLCanvasElement;
        this.gpsCtx = this.gpsCanvas.getContext('2d');
        this.gpsVisible = false;
        this.layerSelect = document.getElementById('layerSelect') as HTMLSelectElement;
        ...
        this.speedGraphCanvas = document.getElementById('speedGraphCanvas') as HTMLCanvasElement;
    ...
    updateFrameDisplay() {
        this.currentFrameSpan.textContent = this.currentFrameNumber.toString();
    }
    ...
    updateTelemetryDisplay() {
        ...
        this.speedValue.textContent = Math.round(data.speed).toString();
        this.latAccValue.textContent = data.latAcc.toFixed(1);
        this.lonAccValue.textContent = data.lonAcc.toFixed(1);
        this.altitudeValue.textContent = Math.round(data.altitude).toString();
    ...
    syncVideoToLapStart(lapIndex) {
        ...
        const syncBtn = event.target as HTMLElement;
    ...
    jumpToLapStart(lapIndex) {
        ...
        const jumpBtn = event.target as HTMLElement;
